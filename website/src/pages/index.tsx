      ...
      <div className={styles.heroContent}>
        ...
        <div className={styles.heroDescription}>
          <p className={styles.descriptionText}>
            ...
            that can be used not only as a <span className={styles.accentWord}>demo</span> of my skills and <span className={styles.accentWord}>sandbox</span> for learning new tools but also as
            infra <span className={styles.accentWord}>foundation</span> for companies of any size.
          </p>
        </div>
